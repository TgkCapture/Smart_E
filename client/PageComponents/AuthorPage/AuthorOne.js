...
const AuthorOne = ({ address, author, properties }) => {
    return (
        <section>
                ...
                <div className="author-content-content">
                    ...
                    <div className="author-content-contain">
                        ...
                        {properties.length ==  0 ? (
                            ...
                            <div className="author-box" onclick="Popup('<?php echo $id ?>',0)">
                            ...
                            <div className="author-popup" id="<?php echo $id ?>">
                                <div className="author-pane">
                                    ...
                                    <div className="author-pane-content">
                                        <div className="author-pane-hide">
                                            <button onclick="Popup('<?php echo $id ?>',1)">
