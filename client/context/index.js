...
export const StateContextProvider = ({ children }) => { 
  ...
  // TODO: fix num and price variables
  const buyPropertyFunction = async (num, price) => {
    // const { productId="5", amount="0.0000000035"} = buying;
    const productId = num + '';
    //const { amount=price} = buying;
    const money = ethers.utils.parseEther(price);
